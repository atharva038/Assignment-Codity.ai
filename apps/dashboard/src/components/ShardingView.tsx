...
export const ShardingView: React.FC<ShardingViewProps> = ({
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="rounded-2xl border border-stone-200 dark:border-zinc-800 bg-white dark:bg-gradient-to-r dark:from-zinc-950 dark:via-zinc-900 dark:to-zinc-950 p-6 shadow-xl relative overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 relative z-10">
          <div>
            <div className="flex items-center gap-2 mb-1 flex-wrap">
              <span className="px-2.5 py-0.5 rounded-full text-[10px] font-mono font-bold bg-orange-500/10 text-orange-600 dark:text-orange-400 border border-orange-500/20 flex items-center gap-1">
            ...
            <h2 className="text-xl font-extrabold tracking-tight text-stone-900 dark:text-white flex items-center gap-2">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className={`px-4 py-2.5 rounded-xl text-xs font-extrabold flex items-center gap-2 shadow-md shadow-orange-500/20 transition-all active:scale-95 cursor-pointer ${
                isSimulating
                  ? 'bg-stone-200 dark:bg-zinc-800 text-stone-500 dark:text-zinc-400 cursor-not-allowed border border-stone-300 dark:border-zinc-700'
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        <div className="lg:col-span-5 rounded-2xl border border-stone-200 dark:border-zinc-800/80 bg-white dark:bg-zinc-900/60 backdrop-blur-md p-5 flex flex-col justify-between shadow-sm">
          <div>
            <div className="flex items-center justify-between mb-3">
              <h3 className="text-xs font-bold uppercase tracking-wider text-stone-800 dark:text-zinc-300 flex items-center gap-2">
                <Sliders className="w-3.5 h-3.5 text-orange-500" />
                Interactive Hash Router Sandbox
              </h3>
              <span className="text-[10px] font-mono text-stone-500 dark:text-zinc-500">Live Math Evaluator</span>
            </div>

            {/* Shard Key Input */}
            <div className="space-y-2 mb-4">
              <label className="text-[11px] font-medium text-stone-600 dark:text-zinc-400">Partition / Shard Key (e.g. Tenant, User ID)</label>
              <div className="relative">
                <input
                  ...
                  className="w-full bg-stone-50 dark:bg-black/60 border border-stone-300 dark:border-zinc-700/80 rounded-xl px-3.5 py-2 text-xs font-mono text-stone-900 dark:text-white focus:outline-none focus:border-orange-500 transition-colors"
                />
                <Sparkles className="w-4 h-4 text-orange-500 absolute right-3 top-2.5 opacity-60" />
              </div>
            </div>

            {/* Preset Key Pills */}
            <div className="space-y-1.5 mb-5">
              <span className="text-[10px] text-stone-500 dark:text-zinc-500 uppercase tracking-wider font-bold">Quick Presets:</span>
                  ...
                  <button
                    ...
                    className={`px-2.5 py-1 rounded-lg text-[10px] font-mono transition-all cursor-pointer ${
                      shardKey === p.key
                        ...
                        : 'bg-stone-100 dark:bg-zinc-800/80 text-stone-700 dark:text-zinc-400 hover:bg-stone-200 dark:hover:bg-zinc-800 hover:text-stone-900 dark:hover:text-zinc-200 border border-stone-300 dark:border-zinc-700/50'
                    }`}
                  >
                    {p.label}
                  </button>
          ...
          <div className="rounded-xl border border-stone-200 dark:border-zinc-800 bg-stone-50 dark:bg-black/80 p-4 space-y-2.5 font-mono text-xs">
            <div className="flex items-center justify-between text-stone-600 dark:text-zinc-400 border-b border-stone-200 dark:border-zinc-800/80 pb-2">
              <span className="text-[11px]">32-Bit FNV-1a Hash</span>
              <span className="text-orange-600 dark:text-orange-400 font-bold">{calculatedHex}</span>
            </div>
            <div className="flex items-center justify-between text-stone-600 dark:text-zinc-400 border-b border-stone-200 dark:border-zinc-800/80 pb-2">
              <span className="text-[11px]">Decimal Value</span>
              <span className="text-stone-900 dark:text-zinc-200 font-semibold">{calculatedHash.toLocaleString()}</span>
            </div>
            <div className="flex items-center justify-between text-stone-600 dark:text-zinc-400 border-b border-stone-200 dark:border-zinc-800/80 pb-2">
              <span className="text-[11px]">Modulo Shard Formula</span>
              <span className="text-stone-800 dark:text-zinc-300">hash % {totalShards} Shards</span>
            </div>
            <div className="flex items-center justify-between pt-1">
              <span className="text-xs font-bold text-stone-900 dark:text-white uppercase tracking-wider">Routed Target Shard</span>
              <span className="px-3 py-1 rounded-full text-xs font-extrabold bg-orange-500/10 text-orange-600 dark:text-orange-400 border border-orange-500/30">
        ...
        <div className="lg:col-span-7 rounded-2xl border border-stone-200 dark:border-zinc-800/80 bg-white dark:bg-zinc-900/60 backdrop-blur-md p-5 flex flex-col justify-between shadow-sm">
          ...
          <div className="w-full bg-stone-50 dark:bg-black/70 rounded-xl border border-stone-200 dark:border-zinc-800 p-4 relative overflow-hidden flex items-center justify-center min-h-[220px]">
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          ...
          <span className="text-[11px] text-stone-500 dark:text-zinc-400 font-mono flex items-center gap-1.5">
            ...
            return (
              <div
                ...
                className={`rounded-2xl border transition-all duration-300 p-5 relative overflow-hidden flex flex-col justify-between ${
                  isTargeted
                    ? 'border-orange-500/80 bg-orange-50/70 dark:bg-gradient-to-b dark:from-orange-950/20 dark:to-zinc-900 shadow-xl shadow-orange-500/10 ring-1 ring-orange-500/50'
                    : 'border-stone-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/50 hover:border-stone-300 dark:hover:border-zinc-700 shadow-sm'
                }`}
              >
                {isTargeted && (
                  <div className="absolute top-0 right-0 bg-orange-500 text-white text-[9px] font-mono font-extrabold uppercase px-2.5 py-0.5 rounded-bl-lg shadow-sm">
                    Active Route Target
                  </div>
                )}
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-[10px] font-mono font-bold px-2 py-0.5 rounded-full bg-stone-100 dark:bg-zinc-800 text-stone-700 dark:text-zinc-300 border border-stone-200 dark:border-zinc-700/60">
                      SHARD #{index}
                    </span>
                  ...
                  <h4 className="text-sm font-bold text-stone-900 dark:text-white truncate mb-1" title={queue.name}>
                    {queue.name}
                  </h4>
                  <p className="text-[10px] font-mono text-stone-500 dark:text-zinc-500 truncate mb-4">
                    ID: {queue.id}
                  </p>

                  <div className="grid grid-cols-2 gap-2 mb-4">
                    <div className="rounded-xl border border-stone-200 dark:border-zinc-800/80 bg-stone-50 dark:bg-black/40 p-2.5">
                      <span className="text-[10px] text-stone-500 dark:text-zinc-400 block font-medium">B-Tree Status</span>
                    ...
                    <div className="rounded-xl border border-stone-200 dark:border-zinc-800/80 bg-stone-50 dark:bg-black/40 p-2.5">
                      <span className="text-[10px] text-stone-500 dark:text-zinc-400 block font-medium">Total Jobs</span>
                      <span className="text-xs font-bold text-orange-600 dark:text-orange-400 mt-0.5 flex items-center gap-1">
                ...
                <div className="border-t border-stone-200 dark:border-zinc-800/80 pt-3 flex items-center justify-between text-[11px] font-mono">
                  <span className="text-stone-500 dark:text-zinc-500">Worker Fleet:</span>
